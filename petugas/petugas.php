    ...
    <div class="container-fluid">
        <div class="sidebar">
            ...
            <div class="main">
                ...
                <div class="list-item">
                    <a href="petugas.php?url=pembayaran">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if (empty($file)) {
                        ...
                        echo "Aplikasi Pembayaran SPP digunkan untuk mempermudah dalam mencatat pembayaran
